...
function SearchResults() {
  ...
  useEffect(() => {
    ...
    return (
        <div className="flex bg-[url('./assets/forest.jpg')] bg-repeat-y bg-center bg-cover" id="background">
      <div className={`flex flex-col w-full items-center bg-black bg-opacity-75`}>
